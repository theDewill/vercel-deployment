...
export default function Home() {
  ...
  let FormContent = {
    cards: [
      ...
      },
      {
        ...
        ex: "e.g, (+94)xxxxxxxxx",
        set: (Inpval: string) =>
          setInputFieldState((prevState) => ({ ...prevState, inpMob: Inpval })),
      },
      ...
      },
      {
        ...
        set: (Inpval: string) =>
          setInputFieldState((prevState) => ({ ...prevState, inpReq: Inpval })),
      },
    ],
  };
  ...
  let blured = "blur";
  let inputField =
    "text-3xl mdm:text-[23px] formMid:text-[23px] mdm:text-center font-bold text-orngclr box-border focus:ring-0  bg-[#0000] border-x-0 border-t-0 border-b-4 border-orngclr mb-[2px] mdm:mb-[1px] w-full focus:border-[#ffffff] border-dotted";
  let txtAreaField =
    "text-l mdm:text-[3vw] font-bold text-orngclr h-42 rounded-[10px] box-border focus:ring-0  bg-[#000] border-2 border-[#000] mb-[2px] w-full focus:border-[#ffffff]";
  return (
    <>
      <Helmet>
      ...
      <div className={mainStyle}>
        ...
        <div className={successStyle} id="tickAnim">
          ...
          <p className="text-center text-lg">
            <p className="text-orngclr font-bold font-[35px]">Thank You... </p>{" "}
            We have Recieved your Requirement <br></br>Our team will contact you
            Soon...
          </p>
          <a
            href="/"
            className="bg-[#ffffff] px-4 py-2 rounded-lg font-bold text-[#000]"
          >
            {" "}
            Continue{" "}
          </a>
                  ...
                  <div className="p-1">
                    <Card>
                      <CardContent className="flex mdm:flex-col  gap-[30px] items-center justify-center p-6">
                        <span className="text-4xl font-semibold navBlock:w-[700px]">
                          {item.title}
                        </span>
                        <p className="mdm:hidden text-4xl text-orngclr font-bold">
                          {">"}
                        </p>
                        {item.item === "Req" ? (
                          <textarea
        ...
        <div
          className={`${blury} flex gap-[40px] lgm:flex-col items-center self-center z-20 mx-[20px]`}
        >
          <div className="bg-[#000] rounded-xl w-[500px] terraLogo:w-[90vw] p-4">
            <p className="font-bold text-orngclr text-xl sm:text-lg  mb-2">
              E-Mail
            </p>
            <p className="text-[rgb(190,190,190)] text-lg sm:text-md">
              Our Customer Relations team will respond to your inquiries via
              email within 24 hours.
            </p>
            <p className="text-[#ffffff] font-bold text-xl mt-6">
              contact@terracodedev.com
            </p>
          </div>
          ...
          <div className="bg-[#000] rounded-xl w-[500px] terraLogo:w-[90vw] p-4">
            ...
            <p className="text-[rgb(190,190,190)] text-lg sm:text-md">
              Contact our Customer Relations team to schedule a meeting or
