...
import mail from "@/public/Projects/mailus.png";
//----IMAGES----//
...
export default function Navbar(attr: any) {
  ...
  const navlist = `flex gap-xxl lgm:hidden`; //custom added gap style
  const btnstr = ` ${attr.show} px-8 py-2 bg-[#ffff] rounded-md lgm:hidden w-fit flex items-center gap-2`;
  ...
  return (
    <div className="m-0 p-2 z-10 flex flex-col w-[100vw] ">
      <div
        className="hidden terraLogo:block self-end px-4 py-[4px] bg-[rgba(0,0,0,0.06)] rounded-[20px]"
      ...
      <nav className="flex items-center justify-between px-[4vw] terraLogo:hidden">
        ...
        <div>
          <ul className={navlist}>
            <a href="../">
              <li className="hover:text-[rgb(124,124,124)] cursor-pointer transition-colors duration-300 ease-in-out">
                Home
              </li>
            </a>
            <a href="../Projects">
            ...
            <a href="https://github.com/Terracode-Dev">
              <li className="hover:text-[rgb(124,124,124)] cursor-pointer transition-colors duration-300 ease-in-out">
                Github
              </li>
            </a>
        ...
        <a
          href="mailto:contact@terracodedev.com?subject=Terracode - Custom Solution Inquiries - Dev/Customer Relations"
          className={btnstr}
        >
          <Image
            src={mail}
