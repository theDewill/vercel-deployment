...
export default function Navblock(attr: any) {
  ...
  return (
    <nav className={parentStyle}>
      <ul
        className="bg-[rgba(68,63,63,0.53)] w-[90vw] rounded-[17px] px-2 flex mb-6 items-center justify-center text-[#fff] text-[13px] gap-4 mx-4"
      ...
      >
        ...
        <li>
          <a
            href="https://github.com/Terracode-Dev"
            className={attr.tile == 3 ? hlTile : nTile}
          >
            <Image
              src={gitNF}
              alt="Home"
