...
export default function Terrians(attr : any) {
    ...
    return(
        <div className = {mainStyle}>
            ...
            <div className="terrianImg image self-center w-[75vw] rounded-[86px] flex terraLogo:flex-col gap-[70px] mdm:gap-[30px] items-center justify-center  py-[50px] px-[80px] bg-cover bg-center bg-no-repeat"
            style={{ backgroundImage: "url('../../public/terriansBack.jpg')" }}>
                ...
                <a href="../Developers" className="border-2 border-orngclr px-4 py-2 rounded-lg"> Dev Wall </a>
            </div>
